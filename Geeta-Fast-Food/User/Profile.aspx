<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="Geeta_Fast_Food.User.Profile" %>
                            ...
                            <div class="card-title mb-4">
                                <div class="d-flex justify-content-start">
                                    ...
                                    <div class="userData ml-3">
                                        ...
                                        <h6 class="d-block">
                                            <a href="javascript:void(0)">
                                                <asp:Label ID="lblCreateDate" runat="server" ToolTip="Account Create On">@<%Response.Write(Session["createDate"]); %></asp:Label>
                                            </a>
                                        </h6>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="tab-content ml-1" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="basicInfo" rolw="tabpanel" aria-labelledby="basicInfo-tab">
                                       ...
                                       <%-- Order History Starts--%>
                                        <div class="tab-pane fade" id="connectedServices" role="tabpanel" aria-labelledby="connectedServices-tab">
                                            ...
                                            <asp:Repeater ID="rPruchaseHistory" runat="server" OnItemDataBound="rPruchaseHistory_ItemDataBound">
                                                <ItemTemplate>
                                                    <div class="container">
                                                        ...
                                                        <asp:Repeater ID="rOrders" runat="server">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="lblOrderNo" runat="server" Text='<%# Eval("OrderDetailsId") %>'></asp:Label>
                                                                    </td>
                                                                    <td>
