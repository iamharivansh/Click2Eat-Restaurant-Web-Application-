<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OrderStatus.aspx.cs" Inherits="Geeta_Fast_Food.Admin.OrderStatus" %>
                                                ...
                                                <div class="table-responsive">
                                                    <asp:Repeater ID="rOrderStatus" runat="server" OnItemCommand="rOrderStatus_ItemCommand">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <tr>
                                                                <td class="table-plus"><%# Eval("OrderDetailsId") %></td>
