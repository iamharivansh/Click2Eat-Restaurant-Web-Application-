<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="Geeta_Fast_Food.Admin.Product" %>
                                        ...
                                        <div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Description is Required" ForeColor="Red" Display="Dynamic"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Price is Required" ForeColor="Red" Display="Dynamic"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Quantity is Required" ForeColor="Red" Display="Dynamic"
                                                        SetFocusOnError="true" ControlToValidate="txtQuantity"></asp:RequiredFieldValidator>

                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Qunatity must be non negative"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    ...
                                                    <asp:DropDownList ID="ddlCategories" CssClass="form-control" runat="server" 
                                                        DataTextField="Name" DataValueField="CategoryId" DataSourceID="SqlDataSource1" AppendDataBoundItems="true" >
                                                    <asp:ListItem Value="0">Select Category</asp:ListItem>
                                                    </asp:DropDownList>
                                                    
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Category is Required" ForeColor="Red" Display="Dynamic"
