<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="Geeta_Fast_Food.User.Menu" %>
                ...
                <div class="row grid">
                    <asp:Repeater ID="rProducts" runat="server" OnItemCommand="rProducts_ItemCommand">
                     ...
                     <div class="col-sm-6 col-lg-4 all <%# Regex.Replace(Eval("CategoryName").ToString().ToLower(),@"\s+","") %>">
                         <div class="box">
                             <div>
                                 <div width="450px" height="450px">
                                     <img src="<%# Utils.GetImageUrl(Eval("ImageUrl")) %>"" alt=""" width="360px" height="300px" class="imgp" ">
                                 </div>
