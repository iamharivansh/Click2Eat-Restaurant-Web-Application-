<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="Geeta_Fast_Food.User.Registration" %>
    ...
    <section class="book_section layout_padding">
        <div class="container">
            <div class="heading_container">
                ...
                <asp:Label ID="lblHeaderMsg" runat="server" Text="<h2>User Registation</h2>"></asp:Label>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>
                            <asp:RequiredFieldValidator ID="rfvUsername" runat="server" ErrorMessage="Usrename is Required" ControlToValidate="txtUsername"
                                ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            <asp:TextBox ID="txtUsername" runat="server" CssClass="form-control" placeholder="Enter Usrename"
                                ToolTip="Usrename"></asp:TextBox>
                        </div>
                ...
                <div class="row pl-4">
                    <div class="btn-box">
                        ...
                        <asp:Label ID="lblAlreadyUser" runat="server" CssClass="pl-3 text-block-100 " Text="Already Registred? <a href='Login.aspx' Class='badge badge-info'>Login here..</a>"></asp:Label>
                    </div>
                </div>
