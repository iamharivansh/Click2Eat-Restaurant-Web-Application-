<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Geeta_Fast_Food.User.Login" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     ...
     <script>
         ...
         window.onload = function () {
             var second = 5;
             setTimeout(function () {
                 document.getElementById("<%=lblMsg1.ClientID%>").style.display = "none";
            }, second * 1000);
         };
     </script>
</asp:Content>
